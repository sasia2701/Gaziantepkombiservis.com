...
<section class="page-header">
    <div class="container">
        <div class="page-header__inner">
            <h2>Karataş Kombi Bakımı</h2>
            <ul class="thm-breadcrumb list-unstyled">
                <li><a href="index.html">Anasayfa</a></li>
                <li><a href="services-classic.html">Hizmetler</a></li>
                <li class="active">Karataş Kombi Bakımı</li>
            </ul>
        </div>
    </div>
</section>
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="services-details__right">
                    ...
                    <div class="services-details__content-one">
                        <h3 class="services-details__title">Kombi Bakımı</h3>
                        <p class="services-details__text-1">Karataş Kombi Servisi olarak, kombi bakım ve onarımında uzmanlaşmış bir kadroya sahibiz. Kombiler, doğalgazla çalışan hassas cihazlar olduğu için, bakım ve onarımlarının yetkin kişilere yapılması gerekmektedir. Alanında deneyimli teknisyenlerimizle Baymak, Alarko, Baxi, Vaillant, Buderus, DemirDöküm, İmmergas, Ferroli, Baykan, Protherm, Viessman ve Airfel markalarının tüm modellerinde geniş bir tecrübeye sahibiz.</p>
                        <p class="services-details__text-2">Periyodik bakım ve arıza onarımları için haftanın her günü ve her saati bize ulaşabilirsiniz. Kombinizin tüm parçalarını titizlikle kontrol ediyor, uygun kimyasallarla temizliyor ve baca limit ve çekiş kontrollerini yapıyoruz. Arıza durumunda, öncelikli hedefimiz kombinizi yerinde onarmaktır; ancak bu mümkün olmadığında, cihazınız tam donanımlı atölyemize götürülüp hızlıca onarılacaktır.</p>
                        <h4 class="services-details__title-2">Kombi Servisimizde Sağladığımız Avantajlar</h4>
                        <p class="services-details__text-3">Enerji tasarrufu sağlayan profesyonel bakım hizmetimizle, kombinizin ömrünü uzatıyoruz. Her marka ve model kombiye yönelik kaliteli teknik destek ve bakım hizmeti sunuyoruz. İletişim için: 0 544 269 47 36</p>
                        <h4 class="services-details__title-3">Hizmetlerimiz</h4>
                        <p class="services-details__text-4">Karataş Kombi Servisi olarak, Baymak, Alarko, Baxi, Vaillant, Buderus, DemirDöküm, İmmergas, Ferroli, Baykan, Protherm, Viessman ve Airfel markalarına özel kombi servisi sunuyoruz. 7/24 teknik destek ve bakım hizmeti almak için bizimle iletişime geçebilirsiniz.</p>
                    </div>
                    ...
                    <p class="services-details__text-5">Gaziantep'te güvenilir ve profesyonel bir kombi servisi arıyorsanız, ekibimizle iletişime geçebilirsiniz. Kombi bakım ve onarımlarınızda size hızlı ve etkili çözümler sunmak için buradayız.</p>
                    <h3 class="services-details__title-4">Kombi Servisi Sağladığımız Markalar</h3>
                    <p class="services-details__text-6">Demirdöküm, Eca, Baymak, Vaillant, Baykan, Airfel, Protherm, Bosch, Buderus ve Daikin markalarına 7/24 teknik destek ve bakım hizmeti sunuyoruz. Garanti süresi dolmuş kombi cihazlarınız için bizimle iletişime geçin.</p>

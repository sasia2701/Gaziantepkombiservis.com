...
<section class="page-header">
    ...
    <div class="container">
        <div class="page-header__inner">
            <h2>Batıkent Kombi Bakımı ve Teknik Destek</h2>
            <ul class="thm-breadcrumb list-unstyled">
                <li><a href="index.html">Anasayfa</a></li>
                <li><a href="services-classic.html">Hizmetler</a></li>
                <li class="active">Batıkent Kombi Bakımı</li>
            </ul>
        </div>
    </div>
</section>
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="services-details__right">
                    ...
                    <div class="services-details__content-one">
                        <h3 class="services-details__title">Batıkent Kombi Bakımı ve Teknik Destek</h3>
                        <p class="services-details__text-1">Gaziantep Batıkent bölgesinde Demirdöküm, Eca, Baymak, Vaillant, Baykan, Airfel, Protherm, Bosch, Buderus ve Daikin markalarına 7/24 teknik destek ve bakım hizmeti sunuyoruz. Garanti süresi dolmuş kombi cihazlarınız için güvenilir ve hızlı servis sağlıyoruz.</p>
                        <p class="services-details__text-2">Batıkent'teki kombi bakım ihtiyaçlarınız için bize günün her saati ulaşabilirsiniz. Profesyonel ekibimiz, her marka kombi için kaliteli teknik destek ve bakım hizmeti sunmaktadır. Bizimle iletişime geçin ve sorunsuz bir hizmet deneyimi yaşayın.</p>
                        <h4 class="services-details__title-2">Kombi Servisimizde Sağladığımız Avantajlar</h4>
                        <p class="services-details__text-3">Teknik destek ve bakım hizmetlerimiz, enerji tasarrufu sağlayarak kombinizin ömrünü uzatır. Profesyonel ekibimizle, her marka ve model kombiniz için en iyi hizmeti sunuyoruz. İletişim: 0 544 269 47 36</p>
                        <h4 class="services-details__title-3">Hizmetlerimiz</h4>
                        <p class="services-details__text-4">Demirdöküm, Eca, Baymak, Vaillant, Baykan, Airfel, Protherm, Bosch, Buderus ve Daikin markalarına özel kombi servisi sunuyoruz. 7/24 teknik destek ve bakım hizmeti için bizimle iletişime geçebilirsiniz.</p>
                    </div>
                    ...
                    <p class="services-details__text-5">Gaziantep'te Batıkent bölgesinde kombi servisi arıyorsanız, güvenilir ve profesyonel hizmet sunan ekibimizle iletişime geçebilirsiniz. Kombinizin bakım ve onarımlarında size yardımcı olmak için buradayız. Bizimle iletişime geçin ve kombi sorunlarınızı hızlı bir şekilde çözün.</p>
                    <h3 class="services-details__title-4">Kombi Servisi Sağladığımız Markalar</h3>
                    <p class="services-details__text-6">Demirdöküm, Eca, Baymak, Vaillant, Baykan, Airfel, Protherm, Bosch, Buderus ve Daikin markalarına 7/24 teknik destek ve bakım hizmeti sunuyoruz. Garanti süresi dolmuş kombi cihazlarınız için bizi arayın.</p>

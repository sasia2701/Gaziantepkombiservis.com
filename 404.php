...
?>
        ...
        <section class="page-header">
            <div class="page-header-bg" style="background-image: url(assets/images/backgrounds/page-header-1-3.jpg)">
            </div>
        ...
        <section class="error-page">
            <div class="error-page-shape-bg float-bob-x"
                style="background-image: url(assets/images/shapes/error-page-shape-bg.png);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="error-page__inner">
                            <div class="error-page__title-box">
                                <h2 class="error-page__title">
                                    <span class="clr-primary">4</span>
                                    <span class="clr-black">0</span>
                                    <span class="clr-base">4</span>
                                </h2>
                            </div>
                            <h3 class="error-page__tagline">Sorry, Something Went Wrong</h3>
                            <p class="error-page__text">The page you are looking for was never existed.</p>
                            <a href="index.html" class="error-page__btn">Go To Home</a>
                        </div>
                    </div>
                </div>
            </div>

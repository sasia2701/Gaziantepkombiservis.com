...
<section class="page-header">
    ...
    <div class="container">
        <div class="page-header__inner">
            <h2>Güneykent Kombi Servisi</h2>
            <ul class="thm-breadcrumb list-unstyled">
                <li><a href="index.html">Anasayfa</a></li>
                <li><a href="services-classic.html">Hizmetler</a></li>
                <li class="active">Güneykent Kombi Servisi</li>
            </ul>
        </div>
    </div>
</section>
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="services-details__right">
                    ...
                    <div class="services-details__content-one">
                        <h3 class="services-details__title">Güneykent Kombi Servisi</h3>
                        <p class="services-details__text-1">Gaziantep Güneykent bölgesinde Demirdöküm, Eca, Baymak, Vaillant, Baykan, Airfel, Protherm, Bosch, Buderus ve Daikin markalarına 7/24 teknik destek ve bakım hizmeti sunuyoruz. Garanti süresi dolmuş kombi cihazlarınız için güvenilir ve hızlı servis sağlıyoruz.</p>
                        <p class="services-details__text-2">İhtiyacınıza uygun kombi servisi için bize günün her saati ulaşabilirsiniz. Profesyonel ekibimiz, her marka kombi için kaliteli teknik destek ve bakım hizmeti sunmaktadır. Bizimle iletişime geçin ve sorunsuz bir hizmet deneyimi yaşayın.</p>
                    ...
                    <p class="services-details__text-5">Gaziantep'te kombi servisi arıyorsanız, güvenilir ve profesyonel hizmet sunan ekibimizle iletişime geçebilirsiniz. Kombinizin bakım ve onarımlarında size yardımcı olmak için buradayız. Bizimle iletişime geçin ve kombi sorunlarınızı hızlı bir şekilde çözün.</p>

...
<section class="page-header">
    <div class="container">
        <div class="page-header__inner">
            <h2>Gaziantep'te Klima Kurulumu</h2>
            <ul class="thm-breadcrumb list-unstyled">
                <li><a href="index.html">Anasayfa</a></li>
                <li><a href="services-classic.html">Hizmetler</a></li>
                <li class="active">Gaziantep Klima Kurulumu</li>
            </ul>
        </div>
    </div>
</section>
                ...
                <div class="services-details__left">
                    <div class="sidebar__single sidebar__category">
                        ...
                        <ul class="sidebar__category-list list-unstyled">
                            ...
                            <li><a href="klima-kurulumu.php" class="{{activeClass('klima-kurulumu.php')}}">Gaziantep Klima Kurulumu</a></li>
                            <li><a href="klima-bakimi.php" class="{{activeClass('klima-bakimi.php')}}">Gaziantep Klima Bakımı</a></li>
                    ...
                    <div class="sidebar__single sidebar__call-box">
                        ...
                        <div class="sideber__call-content">
                            <h3 class="sideber__call-title">7/24 Klima Kurulumu ve Servisi</h3>
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="services-details__right">
                    <div class="services-details__content-one">
                        <h3 class="services-details__title">Gaziantep'te Profesyonel Klima Kurulumu</h3>
                        <p class="services-details__text-1">Gaziantep'te klima kurulumu ihtiyaçlarınız için en iyi hizmeti sunuyoruz. <strong>Daikin</strong>, <strong>Fujitsu</strong>, <strong>LG</strong>, <strong>Samsung</strong>, <strong>Mitsubishi</strong> ve diğer popüler klima markalarının profesyonel kurulumunu yapıyoruz.</p>
                        <p class="services-details__text-2">Uzman ekibimiz, klima cihazlarınızın montajını hızlı ve güvenilir bir şekilde gerçekleştirir. Kurulum sonrası sistemin verimli çalışmasını sağlamak için gerekli tüm test ve ayarları yapıyoruz.</p>
                        <p class="services-details__text-3">Gaziantep'te klima kurulumu için bizimle iletişime geçin. Hem yeni klima kurulumları hem de mevcut sistemlerinizin uyumlu şekilde monte edilmesi için profesyonel destek sunuyoruz.</p>
                        <!-- Diğer içerikler buraya eklenebilir -->
                    </div>
                    <p class="services-details__text-5">Bu hizmetle ilgili daha fazla bilgi almak için bizimle iletişime geçin. Gaziantep'teki en iyi klima kurulumu hizmeti için hemen arayın!</p>
                </div>
            </div>
        </div>
    </div>

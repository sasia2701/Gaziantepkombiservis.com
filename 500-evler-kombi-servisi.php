...
<section class="page-header">
    ...
    <div class="container">
        <div class="page-header__inner">
            <h2>500 Evler Kombi Servisi</h2>
            <ul class="thm-breadcrumb list-unstyled">
                <li><a href="index.html">Anasayfa</a></li>
                <li><a href="services-classic.html">Hizmetler</a></li>
                <li class="active">500 Evler Kombi Servisi</li>
            </ul>
        </div>
    </div>
</section>
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="services-details__right">
                    ...
                    <div class="services-details__content-one">
                        <h3 class="services-details__title">500 Evler Kombi Servisi</h3>
                        <p class="services-details__text-1">Gaziantep 500 Evler bölgesinde Demirdöküm, Eca, Baymak, Vaillant, Baykan, Airfel, Protherm, Bosch, Buderus ve Daikin markalarına 7/24 teknik destek ve bakım hizmeti sunuyoruz. Garanti süresi dolmuş kombi cihazlarınız için güvenilir ve hızlı servis sağlıyoruz.</p>

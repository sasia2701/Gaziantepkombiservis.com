...
<section class="page-header">
    <div class="container">
        <div class="page-header__inner">
            <h2>Gaziantep'te Klima Bakımı ve Servisi</h2>
            <ul class="thm-breadcrumb list-unstyled">
                <li><a href="index.html">Anasayfa</a></li>
                <li><a href="services-classic.html">Hizmetler</a></li>
                <li class="active">Gaziantep Klima Bakımı</li>
            </ul>
        </div>
    </div>
</section>
                ...
                <div class="services-details__left">
                    ...
                    <div class="sidebar__single sidebar__call-box">
                        ...
                        <div class="sideber__call-content">
                            <h3 class="sideber__call-title">7/24 Klima Servisi ve Bakımı</h3>
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="services-details__right">
                    <div class="services-details__content-one">
                        <h3 class="services-details__title">Gaziantep'te Klima Bakımı ve Servisi</h3>
                        <p class="services-details__text-1">Gaziantep bölgesinde, klima sistemlerinizin bakım ve onarımını yapıyoruz. <strong>Daikin</strong>, <strong>Fujitsu</strong>, <strong>LG</strong>, <strong>Samsung</strong>, <strong>Mitsubishi</strong> ve diğer önde gelen klima markalarının bakımında uzmanız.</p>
                        <p class="services-details__text-2">Klima bakım hizmetlerimiz arasında filtre temizliği, gaz dolumu, sıcaklık ayarları ve sistem kontrolleri yer almaktadır. Hangi markayı kullanıyor olursanız olun, profesyonel ekiplerimizle hizmetinizdeyiz.</p>
                        <p class="services-details__text-3">Gaziantep'te klima bakımında en yüksek kalitede hizmet almak için hemen bizimle iletişime geçin. 7/24 hizmet sunarak, acil durumlar ve düzenli bakımlar için size destek oluyoruz.</p>
                        <!-- Diğer içerikler buraya eklenebilir -->
                    </div>
                    <p class="services-details__text-5">Bu hizmetle ilgili daha fazla bilgi almak için bizimle iletişime geçin. Gaziantep'teki profesyonel klima bakım ve servisi için hemen arayın!</p>
                </div>
            </div>
        </div>
    </div>
